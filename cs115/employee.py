...
class Manager(Employee):  # 2 points
    ...
    def __init__(self, first_name, last_name, title, hours_per_week, hourly_rate, bonus_percent):
        super().__init__(self, first_name, last_name, title, hours_per_week, hourly_rate)
        try:
    ...
    5 points'''
    def get_total_compensation(self):
        beforeBonus = super().get_total_compensation()
        return beforeBonus + beforeBonus * self.__bonus_percent
