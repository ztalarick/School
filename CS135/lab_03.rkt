...
(define (map f lst)
  (if (not (null? lst)) (cons (f (car lst)) (map f (cdr lst))) '() ))
...
(define (filter pred lst)
  (if (not (null? lst)) (if (pred (car lst)) (cons (car lst) (filter pred (cdr lst))) (filter pred (cdr lst))) '()))
...
(define (sum lst)
  (if (not(null? lst)) (+ (car lst) (sum (cdr lst))) 0))
...
(define (product lst)
  (if (not(null? lst)) (* (car lst) (product (cdr lst))) 1))
